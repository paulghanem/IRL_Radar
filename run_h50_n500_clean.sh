#!/bin/bash
#SBATCH --job-name=h50_n500_clean
#SBATCH --output=benchmark_h50_n500_clean_%j.out
#SBATCH --error=benchmark_h50_n500_clean_%j.err
...
echo "==========================================================="
echo "  Benchmark (no float64): horizon=50, num_traj=500"
echo "==========================================================="
...
print()
print('Testing default array dtype:')
...
echo "Running main_lax.py with horizon=50, num_traj=500..."
python main_lax.py --horizon=50 --N_steps=100 --gym_env=Walker2d --lr=1e-4 --num_traj=500 --reward_fn_updates=15 --lambda_=0.01 --rirl_iterations=1 --UB --no-save_images
