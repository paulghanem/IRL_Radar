...
# Load the HalfCheetah expert checkpoint with environment (using latest checkpoint)
model_path = "expert_agents/HalfCheetah-v4/PPO_6600000_steps.zip"
...
print(f"Testing HalfCheetah expert for {num_steps} rollout steps...\n")
