...
#SBATCH -t 03:00:00
#SBATCH --output=swimmer_expert_training_%j.out
#SBATCH --error=swimmer_expert_training_%j.err

echo "=== Swimmer Expert Training on V100-32GB GPU ==="
...
echo ""
echo "Starting Swimmer expert training..."
echo "==========================================="
python regenerate_swimmer_expert.py
echo "==========================================="
echo "Swimmer expert training complete"
