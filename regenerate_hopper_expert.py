#!/usr/bin/env python3
"""
Regenerate Hopper expert using Stable Baselines3 PPO
...
print("=" * 60)
print("Regenerating Hopper Expert with Stable Baselines3")
print("=" * 60)
...
checkpoint_callback = CheckpointCallback(
    save_freq=200_000,
    save_path="expert_agents/Hopper/",
    name_prefix="PPO",
...
print("Checkpoints will be saved every 200k timesteps to expert_agents/Hopper/")
model.learn(total_timesteps=10_000_000, callback=checkpoint_callback)

# Save the model
save_path = "expert_agents/Hopper/PPO.zip"
