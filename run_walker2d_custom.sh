...
#SBATCH -t 00:30:00
#SBATCH --output=walker2d_custom_%j.out
#SBATCH --error=walker2d_custom_%j.err

echo "==================================================="
echo "    Walker2d UB Experiment - Custom Parameters"
echo "==================================================="
...
echo "  Environment: Walker2d"
echo "  N_steps: 100"
echo "  num_traj: 50"
echo "  horizon: 50"
echo "  rirl_iterations: 1"
echo "  reward_fn_updates: 15"
echo "  method: Upper Bound (UB)"
echo "  lr: 1e-4"
echo "  lambda: 0.01"
echo ""
