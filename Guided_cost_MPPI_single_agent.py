...
parser.add_argument("--N_steps",default=3000,type=int,help="The number of steps in the experiment. Total real time duration of experiment is N_steps x dt_ckf")
...
for i in range(100):
    ...
    trajs = [policy.generate_session(args,i,key,state_train)]
