#!/bin/bash
#SBATCH --job-name=benchmark_loop_fixed
#SBATCH --output=benchmark_loop_fixed_%j.out
#SBATCH --error=benchmark_loop_fixed_%j.err
...
echo "=================================================="
echo "  Benchmark: FIXED LOOP VERSION"
echo "=================================================="
...
echo "  Version: FIXED LOOP (JAX array pre-allocation)"
echo "=================================================="
echo ""
...
python main_loop.py --horizon=50 --N_steps=100 --gym_env=Walker2d --lr=1e-4 --num_traj=500 --reward_fn_updates=15 --lambda_=0.01 --rirl_iterations=2 --UB --no-save_images
