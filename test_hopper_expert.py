...
# Load the Hopper expert checkpoint with environment (using latest checkpoint)
model_path = "expert_agents/Hopper/PPO_6200000_steps.zip"
...
print(f"Testing Hopper expert for {num_steps} rollout steps...\n")
