...
#SBATCH -t 2-00:00:00
#SBATCH --output=halfcheetah_improved_training_%j.out
#SBATCH --error=halfcheetah_improved_training_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=ghanem.p@northeastern.edu

echo "=== HalfCheetah-v4 Improved Expert Training on V100-32GB GPU ==="
...
# Configure CUDA library paths for PyTorch
...
echo ""
echo "Starting improved expert training..."
echo "Training duration: 10M timesteps (estimated 4-5 hours)"
echo "Target performance: 4000-6000+ reward per episode"
echo "==========================================="
echo ""

python train_halfcheetah_improved.py
