#!/bin/bash
#SBATCH --job-name=benchmark_loop
#SBATCH --output=benchmark_loop_%j.out
#SBATCH --error=benchmark_loop_%j.err
...
echo "=================================================="
echo "  Benchmark: LOOP VERSION (for loop)"
echo "=================================================="
