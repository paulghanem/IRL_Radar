#!/bin/bash
#SBATCH --job-name=h50_n1000
#SBATCH --output=benchmark_h50_n1000_%j.out
#SBATCH --error=benchmark_h50_n1000_%j.err
...
echo "==========================================================="
echo "  Benchmark: horizon=50, num_traj=1000"
echo "==========================================================="
...
python main_lax.py --horizon=50 --N_steps=100 --gym_env=Walker2d --lr=1e-4 --num_traj=1000 --reward_fn_updates=15 --lambda_=0.01 --rirl_iterations=1 --UB --no-save_images
