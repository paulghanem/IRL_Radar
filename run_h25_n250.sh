#!/bin/bash
#SBATCH --job-name=h25_n250
#SBATCH --output=benchmark_h25_n250_%j.out
#SBATCH --error=benchmark_h25_n250_%j.err
...
echo "==========================================================="
echo "  Benchmark: horizon=25, num_traj=250"
echo "==========================================================="
...
python main_lax.py --horizon=25 --N_steps=100 --gym_env=Walker2d --lr=1e-4 --num_traj=250 --reward_fn_updates=15 --lambda_=0.01 --rirl_iterations=1 --UB --no-save_images
