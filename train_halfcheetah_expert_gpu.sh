...
#SBATCH -t 03:00:00
#SBATCH --output=halfcheetah_expert_training_%j.out
#SBATCH --error=halfcheetah_expert_training_%j.err

echo "=== HalfCheetah Expert Training on V100-32GB GPU ==="
...
echo ""
echo "Starting HalfCheetah expert training..."
echo "==========================================="
echo ""

python regenerate_halfcheetah_expert.py

echo ""
echo "==========================================="
echo "HalfCheetah expert training complete"
