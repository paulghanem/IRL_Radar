...
#SBATCH -t 03:00:00
#SBATCH --output=hopper_expert_training_%j.out
#SBATCH --error=hopper_expert_training_%j.err

echo "=== Hopper Expert Training on V100-32GB GPU ==="
...
echo ""
echo "Starting Hopper expert training..."
echo "==========================================="
echo ""

python regenerate_hopper_expert.py

echo ""
echo "==========================================="
echo "Hopper expert training complete"
