#!/usr/bin/env python3
"""
Regenerate HalfCheetah expert using Stable Baselines3 PPO
...
print("=" * 60)
print("Regenerating HalfCheetah Expert with Stable Baselines3")
print("=" * 60)
...
print("Checkpoints will be saved every 200k timesteps to expert_agents/HalfCheetah-v4/")
model.learn(total_timesteps=10_000_000, callback=checkpoint_callback)

# Save the model
save_path = "expert_agents/HalfCheetah-v4/PPO.zip"
