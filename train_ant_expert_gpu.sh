...
#SBATCH -t 03:00:00
#SBATCH --output=ant_expert_training_%j.out
#SBATCH --error=ant_expert_training_%j.err

echo "=== Ant Expert Training on V100-32GB GPU ==="
...
echo ""
echo "Starting Ant expert training..."
echo "==========================================="
python regenerate_ant_expert.py
echo "==========================================="
echo "Ant expert training complete"
