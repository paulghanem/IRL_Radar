...
# ==================== MPPI CONFIGURATION ======================== #
parser.add_argument('--horizon', default=100,type=int, help='Horizon for MPPI control')
...
for i in range(30):
    if (i== 0):
        base = osp.join("expert_agents", "Pendulum-v1", "ppo")
    ...
    trajs = [policy.RGCL(args,params,i,state_train,D_demo,mpc_method,thetas)]
...
visualization_irl = [policy.RGCL(args,params,i,state_train,D_demo,mpc_method,thetas)]
